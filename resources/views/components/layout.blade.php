...
<body>
    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="shrink-0">
                <img src="{{ asset('img/logo.jpeg') }}" alt="Your Company" class="size-12" />
            </div>
            ...
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <el-dropdown class="relative ml-3">
                    <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                        ...
                        <img src="{{ asset('img/me.jpeg') }}" alt="" class="size-12 rounded-full outline -outline-offset-1 outline-white/10" />
                    </button>
                </el-dropdown>
            </div>
            </div>
        ...
        <div class="border-t border-white/10 pt-4 pb-3">
            ...
            <div class="shrink-0">
                <img src="{{ asset('img/me.jpeg') }}" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
            </div>
            <div class="ml-3">
